...
public class SwitchToggleBinary extends CommandClass {

	public static final byte COMMAND_CLASS_ID = (byte) 0x28;
	public static final String COMMAND_CLASS_NAME = "COMMAND_CLASS_SWITCH_TOGGLE_BINARY";

	public static final byte SWITCH_TOGGLE_BINARY_CMD_SET = 0x01;
	public static final byte SWITCH_TOGGLE_BINARY_CMD_GET = 0x02;
	public static final byte SWITCH_TOGGLE_BINARY_CMD_REPORT = 0x03;
	...
	public boolean handleMsg(byte[] data, int length, byte instance) {
		if (SWITCH_TOGGLE_BINARY_CMD_REPORT == data[0]) {
	...
	public void createVars(byte mInstance) {
		if (node != null) {
			node.getValueManager().createValueBool(ValueGenre.USER,
					getCommandClassId(), mInstance, (byte) 0, "Toggle Switch",
