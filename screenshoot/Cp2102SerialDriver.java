...
public class Cp2102SerialDriver extends CommonUsbSerialDriver {
    ...
    /*
     * Default values, patched by: peradnya@gmail.com Using information from
     * SerialController.cpp in Open Z-Wave source.
     * source: https://code.google.com/p/open-zwave/source/browse/trunk/cpp/src/platform/SerialController.cpp
     */
    ...
    public void open() throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < dataIface.getEndpointCount(); i++) {
                ...
                if (ep.getType() == UsbConstants.USB_ENDPOINT_XFER_BULK) {
                    if (ep.getDirection() == UsbConstants.USB_DIR_IN) {
                        mReadEndpoint = ep;
                        // } else { (may cause bug in writing data to USB,
                        // patched by: peradnya@gmail.com)
            ...
            /*
             * Bauddiv patch by: peradnya@gmail.com Using information from
             * cp210x.c
             * source: http://www.cs.fsu.edu/~baker/devices/lxr/http/source/linux/drivers/usb/serial/cp210x.c
             */
            ...
            setConfigSingle(SILABSER_SET_BAUDDIV_REQUEST_CODE,
                    (BAUD_RATE_GEN_FREQ + DEFAULT_BAUD_RATE / 2)
                            / DEFAULT_BAUD_RATE);
            ...
            /*
             * unused source from original source.
             * 
             * setConfigSingle(SILABSER_SET_BAUDDIV_REQUEST_CODE,
