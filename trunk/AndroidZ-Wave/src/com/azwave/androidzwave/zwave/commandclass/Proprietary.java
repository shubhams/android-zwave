...
public class Proprietary extends CommandClass {

	public static final byte COMMAND_CLASS_ID = (byte) 0x88;
	public static final String COMMAND_CLASS_NAME = "COMMAND_CLASS_PROPRIETARY";

	public static final byte PROPRIETARY_CMD_SET = (byte) 0x01;
	public static final byte PROPRIETARY_CMD_GET = (byte) 0x02;
	public static final byte PROPRIETARY_CMD_REPORT = (byte) 0x03;

	public Proprietary(Node node) {
		super(node);
	...
	public boolean handleMsg(byte[] data, int length, byte instance) {
		if (PROPRIETARY_CMD_REPORT == data[0]) {
			return true;
		}
		return false;
	}
